...
<%
		...
		<hr>
		<h3><center><a href='DisplayWorkerProfile'><button type="button" class="btn btn-primary-lg">View Profile</button></a></center></h3> 
		<h3><center><a href='DisplayBooking'><button type="button" class="btn btn-primary-lg">Booking Details</button></a></center></h3> 
